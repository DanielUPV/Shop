        ...
        <div class="half">
          ...
          <ul v-if="clientes.length > 0">
            ...
            <router-link :to="'/cliente/'+cliente.id">
              ...
              <button @click.prevent="deleteCliente(cliente,index)" type="button" :disabled="form.busy" name="button">{{ (form.busy) ? 'Please wait...' : 'Delete'}}</button>
...
export default {
  ...
  methods: {
    listClientes: function(){
      ...
      var that = this;
      this.form.get('/1730142-TAW-42/Market/public/api/clientes').then(function(response){
    ...
    createCliente: function(){
      ...
      var that = this;
      this.form.post('/1730142-TAW-42/Market/public/api/clientes').then(function(response){
    ...
    deleteCliente: function(cliente, index){
      ...
      var that = this;
      this.form.delete('/1730142-TAW-42/Market/public/api/clientes/'+cliente.id).then(function(response){
