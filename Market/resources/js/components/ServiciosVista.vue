<template>
      <div class="ServicioSingle">
        ...
        <form @submit.prevent="updateServicio" v-if="loaded">
          ...
          <router-link to="/servicios"> Back to servicios</router-link>
...
export default {
  ...
  methods: {
    getServicio: function(Servicio){
      ...
      var that = this;
      this.form.get('/1730142-TAW-42/Market/public/api/servicios/'+this.$route.params.id).then(function(response){
    ...
    updateServicio: function(){
      ...
      var that = this;
      this.form.put('/1730142-TAW-42/Market/public/api/servicios/'+this.$route.params.id).then(function(response){
        that.form.fill(response.data);
      })
    ...
    deleteServicio: function(){
      ...
      var that = this;
      this.form.delete('/1730142-TAW-42/Market/public/api/servicios/'+this.$route.params.id).then(function(response){
        that.form.fill(response.data);
