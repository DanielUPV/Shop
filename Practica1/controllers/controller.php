<?php
		...
		public  function vistaUsuariosController(){
			...
			foreach ($respuesta as $row => $item) {
				echo '<tr>
						...
						<td>'.$item["password"].'</td>
						<td>'.$item["email"].'</td>
						<td><a href=index.php?action=editar&idEditar='.$item["id"].'><button class="form-control" >Editar</button></td>
						<td><a href=index.php?action=usuarios&idBorrar='.$item["id"].'><button class="form-control" >Borrar</button></td>';
			}
		}
  ...
  <input class="form-control" type="hidden" value="'.$respuesta["id"].'" name="idEditar" required>
  </div>
  ...
  <div class="form-group">
  <input class="form-control" type="text" value="'.$respuesta["email"].'" name="emailEditar" required>
  </div>
  <div class="form-group">
